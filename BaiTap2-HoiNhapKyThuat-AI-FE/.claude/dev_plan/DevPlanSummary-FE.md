...
| Library / Organization | `.claude/dev_plan/organization/Library-FE.md` | Chờ phê duyệt | 2026-08-07 | Baseline đã hoàn thành; follow-up chờ duyệt: click ngoài vùng chọn set `selectedItem = null`, đổi `Add Vocab`/`Bulk Add` sang tạo/import vocab mới bằng `/api/v1/vocabs?...` thay vì API gắn vocab đã tồn tại |
